const publishers = [
    {
      label: "Major Publishers",
      options: [
        { value: 1, abbr: "bwh", label: "Boosey & Hawkes" },
        { value: 2, abbr: "sim", label: "Simrock" },
        { value: 3, abbr: "edp", label: "Edition Peters" },
        { value: 4, abbr: "alm", label: "Alfred Music" },
        { value: 5, abbr: "sch", label: "Schott Music" },
        { value: 6, abbr: "sik", label: "Sikorski" },
        { value: 7, abbr: "bar", label: "Barenreiter" }
      ]
    },
    {
